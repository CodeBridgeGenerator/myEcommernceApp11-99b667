    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Highways",
          type: "error",
          message: error.message || "Failed get Highways",
        });
      });
